 ...
 * @author Andres
 */
public class Bloquear implements Proceso {
    ...
    public Bloquear(int id, String nombre, long duracion) {
        this.id=id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "Bloquear{" + "id=" + id + ", nombre=" + nombre + ", duracion=" + duracion + ", trestante=" + trestante + ", quantum=" + quantum + '}';
    }
